...
class ScenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create scene" do
    assert_difference('Scene.count') do
      post scenes_url, params: { scene: { content: @scene.content, position: @scene.position, story_id: @scene.story_id, title: @scene.title } }
    end
  ...
  test "should update scene" do
    patch scene_url(@scene), params: { scene: { content: @scene.content, position: @scene.position, story_id: @scene.story_id, title: @scene.title } }
